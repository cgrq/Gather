...
const NAME_OF_BUCKET = "gather-city";
...
const singleFileUpload = async ({ file, public = false }) => {
    ...
    // Return the link if public. If private, return the name of the file in your S3 bucket as the key in your database for subsequent retrieval.
